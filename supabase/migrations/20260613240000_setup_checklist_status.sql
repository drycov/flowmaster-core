-- Extend init status: blocking needs_setup vs full admin checklist visibility.
...
DECLARE
  ...
  v_setup_checklist_incomplete boolean;
BEGIN
  SELECT to_jsonb(o)
    INTO v_org
  ...
  v_setup_checklist_incomplete := v_admin_count = 0
    OR NOT v_org_configured
    OR v_dept_count = 0
    OR v_wf_published = 0
    OR v_tpl_published = 0;
  ...
  RETURN jsonb_build_object(
    ...
    'setup_checklist_incomplete', v_setup_checklist_incomplete
  );
END;
$$;
