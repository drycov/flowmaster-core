...
const styles: Record<string, string> = {
  ...
  returned_for_revision:
    "bg-[oklch(0.95_0.05_75)] text-[oklch(0.4_0.15_75)] border-[oklch(0.72_0.13_75)]",
  pending: "bg-[oklch(0.95_0.05_75)] text-[oklch(0.4_0.15_75)] border-[oklch(0.72_0.13_75)]",
  in_progress:
    "bg-[oklch(0.93_0.06_250)] text-[oklch(0.32_0.13_250)] border-[oklch(0.78_0.08_250)]",
