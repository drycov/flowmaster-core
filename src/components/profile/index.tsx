...
export default function ProfilePage({ viewUserId }: ProfilePageProps) {
  ...
  const displayName =
    localized(profile, locale, "full_name") || profile.email || profile.iin || t("profile.title");
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Tabs defaultValue="info">
            ...
            <TabsContent value="info" className="space-y-4">
              ...
              {isOwnProfile ? <MyAccessLevelCard accessLevelId={profile.access_level_id} /> : null}

              {!isOwnProfile ? (
                <UserAccessLevelCard userId={profile.id} accessLevelId={profile.access_level_id} />
              ) : null}
